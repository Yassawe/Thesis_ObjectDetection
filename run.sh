...
# export LD_LIBRARY_PATH=/src/main/modified_nccl/deviceDropping_X2/build/lib/
# python3 -m torch.distributed.run --nproc_per_node 4 train.py --epochs 600 --batch 256 --data VOC.yaml --weights '' --cfg yolov5m.yaml --hyp ./data/hyps/hyp.VOC.yaml --device 0,1,2,3 --cache ram --name revorder --project adaptive
...
# export LD_LIBRARY_PATH=/usr/lib/x86_64-linux-gnu/
# nvprof --devices 0 --concurrent-kernels on --profile-child-processes --trace gpu --print-gpu-trace --openacc-profiling off --normalized-time-unit ms --profile-from-start off --csv --log-file ./csv/YOLOs%p.csv python3 -m torch.distributed.run --nproc_per_node 4 train.py --epochs 400 --batch 256 --data VOC.yaml --weights '' --cfg yolov5s.yaml --hyp ./data/hyps/hyp.VOC.yaml --device 0,1,2,3 --cache ram --name profile --project profile


# export LD_LIBRARY_PATH=/src/main/modified_nccl/deviceDropping_X1/build/lib/
# nvprof --devices 0 --concurrent-kernels on --profile-child-processes --trace gpu --print-gpu-trace --openacc-profiling off --normalized-time-unit ms --profile-from-start off --csv --log-file ./csv/YOLOs_X1%p.csv python3 -m torch.distributed.run --nproc_per_node 4 train.py --epochs 400 --batch 256 --data VOC.yaml --weights '' --cfg yolov5s.yaml --hyp ./data/hyps/hyp.VOC.yaml --device 0,1,2,3 --cache ram --name profile --project profile


# export LD_LIBRARY_PATH=/src/main/modified_nccl/deviceDropping_X2/build/lib/
# nvprof --devices 0 --concurrent-kernels on --profile-child-processes --trace gpu --print-gpu-trace --openacc-profiling off --normalized-time-unit ms --profile-from-start off --csv --log-file ./csv/YOLOs_X2%p.csv python3 -m torch.distributed.run --nproc_per_node 4 train.py --epochs 400 --batch 256 --data VOC.yaml --weights '' --cfg yolov5s.yaml --hyp ./data/hyps/hyp.VOC.yaml --device 0,1,2,3 --cache ram --name profile --project profile


# export LD_LIBRARY_PATH=/src/main/modified_nccl/deviceDropping_X1Y1/build/lib/
# nvprof --devices 0 --concurrent-kernels on --profile-child-processes --trace gpu --print-gpu-trace --openacc-profiling off --normalized-time-unit ms --profile-from-start off --csv --log-file ./csv/YOLOs_X1Y1%p.csv python3 -m torch.distributed.run --nproc_per_node 4 train.py --epochs 400 --batch 256 --data VOC.yaml --weights '' --cfg yolov5s.yaml --hyp ./data/hyps/hyp.VOC.yaml --device 0,1,2,3 --cache ram --name profile --project profile
